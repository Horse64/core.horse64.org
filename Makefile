...
test-translator:
	...
	python3 -m unittest discover -v tools 'test*.py'
	...
	rm -rf ./tests/network/horse_modules/core.horse64.org/
	...
	cp -R /tmp/h64-test-core-copy/ ./tests/network/horse_modules/core.horse64.org/
	rm -rf /tmp/h64-test-core-copy/
